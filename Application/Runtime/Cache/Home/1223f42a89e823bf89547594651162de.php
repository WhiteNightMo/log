            ...
            <div class="row log">
                <div class="col-lg-12">
                    <div class="well well-lg" style="border-left: 8px #333 solid;">
                        <header><h2><?php echo ($tips); ?></h2></header>
                    </div>
                    <!-- /.panel -->
                </div>
                <!-- /.col-lg-12 -->
            ...
            <div class="row log">
                <div class="col-lg-12">
                    <div class="well well-lg">
                        <article>
                            <header><h2><?php echo ($log['title']); ?></h2></header>
                            ...
                            <footer>
                                ...
                                <?php if(session('user') && session('user') == $log['user']): ?><span class="log-footer">
                                        <span class="fa fa-pencil fa-fw"></span>
                                        <a href="/log/Home/Post/edit/id/<?php echo ($log['id']); ?>">编辑</a>
                                    </span><?php endif; ?>
                            </footer>
                        </article>
                    </div>
